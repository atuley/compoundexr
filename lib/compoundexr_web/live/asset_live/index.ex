defmodule CompoundexrWeb.AssetLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :assets, Assets.list_assets(socket.assigns.current_user.id))}
  end
  ...
  @impl true
  def handle_info({CompoundexrWeb.AssetLive.FormComponent, {:saved, asset}}, socket) do
